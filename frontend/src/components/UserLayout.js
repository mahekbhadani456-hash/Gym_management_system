          ...
          <div className="navbar-container">
            ...
            >
              ...
              <div className="brand-text">
                <div className="fw-bold brand-title">Gym Member Portal</div>
                <div className="text-muted brand-subtitle">Your Fitness Journey</div>
              </div>
            </Navbar.Brand>
              ...
              <div className="d-none d-lg-flex align-items-center user-actions-desktop" style={{ flexShrink: 0 }}>
                <div className="d-flex align-items-center user-info-card">
                  ...
                  <div className="user-details">
                    <div className="fw-semibold user-name">{user.name || user.username}</div>
              ...
              {user && (
                <div className="mb-4 p-3 rounded user-info-card" style={{ background: '#f8f9fa', border: '1px solid #e9ecef' }}>
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <div className="fw-bold fs-5" style={{ color: '#212529' }}>{user.name || user.username}</div>
